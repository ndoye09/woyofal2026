"""
DASHBOARD STREAMLIT - Accueil (copie sans emoji)
"""
...
with col1:
    ...
    if not eco_df.empty:
        fig_eco = px.bar(eco_df, x='nom_tranche', y='economie_totale_fcfa', color='type_compteur', title=f'Êconomies Totales par Tranche - {periode}', text='economie_totale_fcfa', color_discrete_map={'DPP':'#90EE90','PPP':'#87CEEB'})
