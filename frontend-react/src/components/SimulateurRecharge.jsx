...
const simulerRechargeLocal = (montant, typeCompteur = 'DPP', cumulActuel = 0, phase = 'monophase', nbMois = 0) => {
  ...
  if (montantReste <= 0) {
    ...
    return {
      ...
      details: `Il te manque ${montantManquant} FCFA. Tu as recharger ${montant} FCFA, mais tu dois recharger un minimum de ${montantBrutMinimum} FCFA pour obtenir 1 kWh.`,
