  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-accent': '0 0 32px rgba(220,38,38,0.4)',
        'glow-success': '0 0 32px rgba(16,185,129,0.4)',
        'inner-sm': 'inset 0 1px 2px rgba(0,0,0,0.06)',
        'xl': '0 20px 60px rgba(0,0,0,0.15)',
      },
      backgroundImage: {
        'hero-gradient': 'radial-gradient(ellipse 90% 70% at 60% 0%, rgba(37,99,235,0.3), transparent), linear-gradient(160deg, #1A1D2E 0%, #2D3748 55%, #1E40AF 100%)',
